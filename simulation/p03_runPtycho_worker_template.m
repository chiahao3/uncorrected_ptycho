...
% This template script controls only the shared reconstruction
% parameter, while other parameters are created outside of this template script
% You don't need to execute this script because it's called by the master.m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
