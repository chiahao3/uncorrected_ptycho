...
kmax_dir= 'kmax2';
%'kmax2', 'kmax4'
main_dir = strcat('/home/fs01/cl2696/20231219_ptycho_recon_', kmax_dir); % Change this to the actual input folder
...
N_true = 1024; % size of the probe when generating initial guess, should be larger or around 1024
...
alpha_dirs= {'alpha_10.5mrad_', 'alpha_23.1mrad_', 'alpha_40.0mrad_'};
%{'alpha_10.5mrad_', 'alpha_23.1mrad_', 'alpha_40.0mrad_'};
cs_dirs= {'Cs_1.0um_', 'Cs_1.1mm_'};%{'Cs_0.5um_', 'Cs_1.0mm_'};
target_shapes= {'dp_128_', 'dp_256_', 'dp_512_'}; %dp_128_', 'dp_256_', 'dp_512_', 'dp_1024_'
detector_blur_stds= {'blur_0px_'};%, 'blur_0.5px_', 'blur_1px_', 'blur_2px_'};
doses= {'dose_1.0e+07ePerAng2'}; %{'dose_1.0e+06ePerAng2','dose_1.0e+08ePerAng2', 'dose_1.0e+14ePerAng2'};

custom_positions_source= '/home/fs01/cl2696/Cornell_ALTAS_script/20231219_cluster_ptycho_recon_job_scripts/true_position_std0.1.hdf5';
%%
