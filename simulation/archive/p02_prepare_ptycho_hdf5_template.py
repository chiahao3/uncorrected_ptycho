...
simu_dir = '20231219_abTEM_realistic_ptycho_simu'
output_dir = '20231219_ptycho_recon' # Parent output dir, or equvalently the "exp_dir"

potential_modes= ['static']
#['static', 'phonon']
coherence_modes= ['temporal_spatial']
#['coherent', 'temporal', 'spatial', 'temporal_spatial']
alpha_dirs= ['alpha_1.0mrad']
