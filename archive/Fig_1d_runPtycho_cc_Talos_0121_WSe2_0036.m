...
scan_dir = '0036_step128_20.5Mx_cl98mm_10.5mrad_df0_19pA'; % change this for different scans
...
Nprobe = 15; % # of probe modes
variable_probe_modes = 2; % 2 if possible # of modes for variable probe correction
grouping = 256; % group size. small -> better convergence but longer time/iteration
N_pos_corr = 500; % iteration number to start position correction. inf means no position correction
...
init_recon_file = '/scratch/users/chiahao3/20230119_TEM_Talos_200kV_WSe2_16_EMPAD/0036_step128_20.5Mx_cl98mm_10.5mrad_df0_19pA/2/roi2_Ndp256_step128/MLs_L1_p10_g512_pc0_noModel_updW100_vp2_vi_mm/Niter9000.mat';
...
object_change_start = 500;       % Start updating object at this iteration number
