...
exp_dir = '/scratch/users/chiahao3/20230119_TEM_Talos_200kV_WSe2_16_EMPAD/'; %change this for different experiment
scan_dir = '0016_step128_20.5Mx_cl98mm_7.50mrad_df0_19pA'; % change this for different scans
...
voltage = 200;
alpha0 = 7.45; %convergence semi angle # 18->18.44, 25.2->24.92, 36->36.4, 54->55.45
rbf = 5.07; %radius of central disk in px at given camera length. 16 - cl 230 mm; 
...
grouping = 512; % group size. small -> better convergence but longer time/iteration
...
init_recon_file = '/scratch/users/chiahao3/20230119_TEM_Talos_200kV_WSe2_16_EMPAD/0016_step128_20.5Mx_cl98mm_7.50mrad_df0_19pA/2/roi2_Ndp256_step128/MLs_L1_p10_g512_pc0_noModel_updW100_vp2_vi_mm/Niter20000.mat';
use_previous_probe = true; %set false when you use a new data set
use_previous_object = true; %false for new data
use_previous_position = true; % false for new data
...
p.   detector.upsampling = 1;                           % upsample the measured data by 2^data_upsampling, (transposed operator to the binning), it can be used for superresolution in nearfield ptychography or to account for undersampling in a far-field dataset
